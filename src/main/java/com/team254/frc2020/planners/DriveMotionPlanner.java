package com.team254.frc2020.planners;
...
public class DriveMotionPlanner implements CSVWritable {
    ...
    protected DriveOutput updatePID(DifferentialDrive.DriveDynamics dynamics, Pose2d current_state) {
        ...
        return new DriveOutput(wheel_velocities.left, wheel_velocities.right, dynamics.wheel_acceleration.left, dynamics
                .wheel_acceleration.right, left_voltage, right_voltage);
    }

    protected DriveOutput updatePurePursuit(DifferentialDrive.DriveDynamics dynamics, Pose2d current_state) {
